...
-- (Nota: Como no cargamos DimFecha en esta versión, buscaremos si hay transacciones sin Descuento en FactVentas)
-- Usa IS NULL:
SELECT * 
FROM FactVentas 
WHERE Descuento_Pct IS NULL;
...
-- Éxito: 6 filas.
SELECT COUNT(*) AS Ventas_Criticas
FROM FactVentas
WHERE FechaID BETWEEN 20231101 AND 20231130
